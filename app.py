...
st.write("The Fintech Readiness Index (FRI) is calculated using a robust statistical pipeline  based on four main dimensions:")
...
st.markdown("4. **Diagnostics:** *(Coming soon)* View the statistical validation (KMO, Moran's I).")
